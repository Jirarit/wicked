 ...
 * @author Win
 */
class DestroyController extends AppController{
    ...
    public function destroy($product_id, $destroy_qty) {
        $this->ProductMovement->add("DES" , $product_id , $destroy_qty , date('Y-m-d H:i:s'));
